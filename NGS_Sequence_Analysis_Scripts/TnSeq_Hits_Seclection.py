# -*- coding: utf-8 -*-
"""
Created on Sun Apr 12 08:42:01 2015
...
in_path = "C:\Users\Liu\Desktop\YL\NormalizedReads\\" ## change file path here
out_path = "C:\Users\Liu\Desktop\YL\AnalyzedData\\"
...
for file_name in glob.glob(os.path.join(in_path, '*.csv')):
    ...
    #calculate sum(values_in_a_gene) for all genes 
    #| normalize against length of gene | calculate mean, SD for 
    #all genes | output items whose value > mean+3*SD or < mean-3*SD )
